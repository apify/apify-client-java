 ...
 * doNotRetryTimeouts} correctly. A transport implementation that cannot tell the two apart may
 * throw a plain {@link IOException} instead; the call is then simply always eligible for a retry.
 */
