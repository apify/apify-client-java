...
public final class TaskPublicConfig extends ApifyResource {
  ...
  public List<String> getInputSchemaFields() {
    // Jackson binds directly to the (private) `inputSchemaFields` field for deserialization, which
    // can leave it null (field absent or explicit `null` in the response) - null-coalesce that.
